 ...
 * @desc    Send a one-time verification code to the signed-in user's email
 * @access  Private
 */
router.post(
  "/send-verification",
 ...
 * @desc    Confirm a one-time verification code for the signed-in user
 * @access  Private
 */
router.post("/verify-email", protect, checkAccountStatus, verifyEmail);
